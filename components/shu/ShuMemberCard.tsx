  ...
  const columns = useMemo<InventoryDataTableColumn<MemberDistribution>[]>(
    () => [
      ...
      },
      {
        ...
        render: (row) => <Text style={styles.rowCell}>{formatRupiah(row.shu_belanja_amount)}</Text>,
      },
      {
        key: "shu_usaha",
        title: "Business SHU",
        ...
        render: (row) => <Text style={styles.rowCell}>{formatRupiah(row.shu_usaha_amount)}</Text>,
      },
      {
        key: "shu_total",
        title: "Total SHU",
