...
export default function ProductDetailModal({ visible, children }: ProductDetailModalProps) {
      ...
      <View style={styles.backdrop}>
        <View
          style={[
            styles.modal,
            {
              maxWidth: isPhone ? Math.max(shortSide * 0.94, 320) : 540,
              maxHeight: isPhone ? height * 0.82 : height * 0.9,
            },
          ]}
        >
