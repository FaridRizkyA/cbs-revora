CREATE TABLE tbl_shu_distributions (
    ...
    eligible_business_shu BOOLEAN NOT NULL DEFAULT TRUE,
    sales_shu_amount NUMERIC(15, 2) NOT NULL DEFAULT 0,
    business_shu_amount NUMERIC(15, 2) NOT NULL DEFAULT 0,
    ...
    CONSTRAINT chk_shu_distributions_sales_shu
        CHECK (sales_shu_amount >= 0),

    CONSTRAINT chk_shu_distributions_business_shu
        CHECK (business_shu_amount >= 0),
